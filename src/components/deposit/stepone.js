...
import DepositType from "../topup/depositType";
...
import OfflineCheck from '../topup/offlineCheck';


// creating functional component ans getting props from app.js and destucturing them
const StepOne = ({ nextStep, setValue,links, values, setCurrency}) => {
                ...
                switch (stepp) {
                    ...
                    case 3:
                        return (
                            ...
                            <OfflineCheck nextStepOnline={nextStepOnline} prevStepOnline={prevStepOnline} handleFormData={handleInputData} values={formData} />
    ...
    const [Profiler, showProfile] = useState();

    useEffect(() => {
        const data = JSON.parse(localStorage.getItem("loginData"));
        showProfile(data.CompletedProfile);
            ...
            >
                ...
                <Div m={{ t: "2rem" }} justify="center">
                    ...
                    <Div d="flex" justify="center">
                        ...
                        <NavLink to= {`${links === "Deposit" ? '/investment' : '/ResInvestment'}`}>
    ...
    //states that determine which steps one is taking after they choose th deposit method
        ...
        <>
            ...
            <Div>
                ...
                <Div border="1px solid"
                    ...
                    <Div d="flex" align="center" p="0.5rem">
                        ...
                        <Text p="0.2rem" textSize="subheader" textWeight="600">
                            Personal /Organization/ investment club/Sacco group/investments
                        </Text>
                    </Div>
                    <Div d="flex" align="center" m={{ l: "2.5rem", b: "1.5rem" }}>
                        <Text className="div_notes">
                            Deposit money to your personal investment account and continue
                        </Text>
                    </Div>
                    <ModalSteps
                        isOpen={showTopUP}
                ...
                <Div
                    ...
                    <Div d="flex" align="center" m={{ l: "2.5rem", b: "1.5rem" }}>
                        <Text className="div_notes">
                            Deposit money to your sacco group
                ...
                <Div
                    ...
                    <Div d="flex" align="center" m={{ l: "2.5rem", b: "1.5rem" }}>
                        <Text className="div_notes">
                            Deposit to your investment club and build a joint dream.
                        </Text>
                    </Div>
